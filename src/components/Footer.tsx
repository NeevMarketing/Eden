...
const Footer: React.FC = () => {
  return (
    <footer className="bg-eden-dark text-white">
        ...
        <div className="container-custom py-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 text-sm">
              <a href="#" className="text-eden-light/80 hover:text-white transition-colors">Privacy Policy</a>
              <a href="#" className="text-eden-light/80 hover:text-white transition-colors">Terms of Service</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <a href="https://wa.me/919876543210" className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white rounded-full p-3 shadow-lg z-50 transition-all duration-300 hover:scale-110">
