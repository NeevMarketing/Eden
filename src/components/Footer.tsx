        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="mb-4">
              <a href="#" className="flex items-center">
                <span className="text-2xl font-serif font-semibold text-white">Eden</span>
                <span className="text-md text-eden-light ml-1 font-light">Gracious Living</span>
              </a>
            </div>
            <p className="text-eden-light/90 mb-4">
              Premium senior residences offering graceful living experiences in Dehradun.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-eden-light hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/eden_wellness_hospitality/?hl=en" target="_blank" className="text-eden-light hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#about" className="text-eden-light/90 hover:text-white transition-colors">About Us</a></li>
              <li><a href="#accommodations" className="text-eden-light/90 hover:text-white transition-colors">Accommodations</a></li>
...
Dehradun 248 009, Uttarakhand, India
              ...
              <li>
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=info@edenseniors.com"
                  target="_blank" className="text-eden-light/90 hover:text-white transition-colors">
          ...
          <div>
            <h5 className="font-serif text-lg mb-4 text-white">Connect With Us</h5>
            <p className="text-eden-light/90 mb-4">
              Have questions or ready to book your stay? Reach out to us directly.
            </p>
            <a href="tel:+917533909333" className="text-eden-light/90 hover:text-white transition-colors">
      ...
      <a href="https://wa.me/917533909333" className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white rounded-full p-3 shadow-lg z-50 transition-all duration-300 hover:scale-110">
