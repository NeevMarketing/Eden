  ...
  return <section className="relative pt-28 md:pt-32 lg:pt-36 pb-16 md:pb-20 lg:pb-32 overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-semibold mb-6 text-eden-dark animate-fade-in lg:text-5xl">Premium Stays Designed for Peace, Space, and Comfort</h1>
