  ...
  const accommodationOptions = [
    {
      ...
      description: "Spacious 1BHK with separate living area and premium wellness amenities for enhanced comfort."
    },
    {
      name: "Hamilton", 
      image: "https://images.unsplash.com/photo-1563298723-dcfebaa392e3?auto=format&fit=crop&q=80",
      description: "Contemporary 1BHK featuring modern design and integrated wellness facilities for mindful living."
    },
    {
      name: "Skyline",
      image: "https://images.unsplash.com/photo-1565182999561-f9a9b5eb7b66?auto=format&fit=crop&q=80",
      description: "Luxury 1BHK with stunning views and comprehensive wellness amenities for complete tranquility."
    }
  ];
  ...
  const exploreOptions = [
    {
      ...
      description: "Comprehensive wellness journeys designed for your 1BHK sanctuary",
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-96 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-5xl font-serif font-bold mb-4">Banner 1 BHK</h1>
          <p className="text-xl font-light">Spacious sanctuary for enhanced wellness living</p>
        </div>
      </section>
      ...
      <main className="section-padding">
        ...
        <section className="container-custom mb-16">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-eden-text text-lg">
              Choose from our curated collection of 1BHK sanctuaries
            </p>
          </div>
        ...
        <section className="container-custom">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <div className="w-20 h-1 bg-eden mx-auto mb-6"></div>
            <p className="text-eden-text text-lg">
              Enhance your 1BHK sanctuary experience
            </p>
          </div>
