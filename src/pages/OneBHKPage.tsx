    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-96 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-5xl font-serif font-bold mb-4">1BHK</h1>
          <p className="text-xl font-light">Discover our luxury 1BHK apartments designed specifically for senior living</p>
        </div>
      </section>
