    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-96 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-5xl font-serif font-bold mb-4">Banner 2 BHK</h1>
          <p className="text-xl font-light">Premium sanctuary for luxurious wellness living</p>
        </div>
      </section>
        ...
        <section className="container-custom mb-16">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-eden-text text-lg">
              Choose from our curated collection of 2BHK sanctuaries
            </p>
          </div>
